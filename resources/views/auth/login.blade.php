                    ...
                    <div class="d-flex w-100 flex-center p-15">
                        <div class="login-wrapper">
                            ...
                            <div class="text-dark-75">
                                ...
                                <h3 class="mb-8 mt-22 font-weight-bold">Login To System</h3>
                                <p class="mb-15 text-muted font-weight-bold">sign in with demo login detail for trying to use this platform.</p>
                        ...
                        <div class="login-wrapper">
                            ...
                            <div class="login-signin">
                                <div class="text-center mb-10 mb-lg-20">
                                    ...
                                    <p class="text-muted font-weight-bold">Enter your mail and password</p>
                                </div>
                                <form class="form text-left" id="kt_login_signin_form" method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
                                    @csrf
                            ...
                            <div class="login-signup">
                                ...
                                <form class="form text-left" id="kt_login_signup_form" method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
                                    @csrf
                                    <div class="form-group py-2 m-0">
