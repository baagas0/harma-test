...
<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Master Data - @stack('title')</title>
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" style="background-image: url({{ asset('assets/media/bg/tu.jpg') }})" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
		<!--begin::Main-->
		<!--begin::Header Mobile-->
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-notice alert-light-{{ session()->get('type') }} fade show" role="alert">
									<div class="alert-icon"><i class="{{ session()->get('icon') }}"></i></div>
